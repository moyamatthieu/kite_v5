...
/**
 * ✅ XPBD : Contrainte avec compliance pour stabilité temporelle
 * Basé sur "XPBD: Position-Based Simulation of Compliant Constrained Dynamics" (Macklin et al.)
 */
export interface XPBDConstraint {
  /** Nom de la contrainte pour debugging */
  name: string;
  /** Compliance (inverse de la raideur) - plus petit = plus rigide */
  compliance: number;
  /** Lambda accumulé (force de contrainte intégrée dans le temps) */
  lambda: number;
  /** Erreur actuelle de la contrainte */
  error: number;
  /** Erreur relative (error/targetLength) */
