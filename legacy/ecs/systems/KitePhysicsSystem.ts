...
export class KitePhysicsSystem extends BaseSimulationSystem {
  ...
  private async initializeComponents(): Promise<void> {
    ...
    // ✅ NOUVEAU: Plus besoin d'entités CTRL séparées
    // Les CTRL sont maintenant des points locaux du kite (architecture couplée)
    // LineSystem et BridleSystem accèdent aux CTRL via geometry.getPointWorld()
    ...
    if (kiteEntity) {
      ...
      this.logger.info(`✅ KiteController initialized with PBD constraint solver`, "KitePhysicsSystem");
    } else {
