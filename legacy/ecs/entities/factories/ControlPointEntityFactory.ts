...
export class ControlPointEntityFactory {
  ...
  static create(
    ...
    // ✅ PHASE 1.2 : PhysicsComponent avec petite masse pour bidirectionnalité PBD
    // invMass = 100 permet transmission forces kite ↔ CTRL ↔ pilote
    entity.addComponent(new PhysicsComponent({
      mass: 0.01, // 10 grammes
      velocity: new THREE.Vector3(0, 0, 0),
      damping: 0.95 // Légère stabilisation numérique
    }));
